...
class CircularCountDownTimerState extends State<CircularCountDownTimer>
  ...
  void _stopHappened() {
    setState(() {
      print("stop");
      _controller?.value = 1;
       // widget.controller!._duration = widget.controller!._initialDuration;
    });
  }
                    ...
                    Positioned.fill(
                      child: CustomPaint(
                        painter: CustomTimerPainter(
                            everStarted: widget.everStarted,
...
class CustomTimerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    double progress = everStarted! ? (animation!.value) * 2 * math.pi : 0;
